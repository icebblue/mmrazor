...
model = dict(
    ...
    '/mnt/cephfs/home/alvin/yangzehang/workplace/DeRy/work_dirs/vit-small_2xb128_cifar100_adamw/epoch_200.pth',  # noqa: E501
    calculate_student_loss=True,
    student_trainable=True,
    distiller=dict(
        type='ConfigurableDistiller',
        student_recorders=dict(
            # bb_1=dict(type='ModuleOutputs', source='backbone.layer4.0'),
            bb_2=dict(type='ModuleOutputs', source='backbone.layer4.2'),
            ),
        teacher_recorders=dict(
            # bb_1=dict(type='ModuleOutputs', source='backbone.timm_model.blocks.10'),
            bb_2=dict(type='ModuleOutputs', source='backbone.timm_model.blocks.11'),
            ),
        distill_losses=dict(
        ...
        connectors=dict(
            # loss_1_sfeat=dict(
            #     type='Conv2TranConnector',
            #     in_channel=2048,
            #     out_channel=384,
            #     stride=2,
            #     ),
            # loss_1_tfeat=dict(type='RMClsTokenConnector'),
            loss_2_sfeat=dict(
                type='Conv2TranConnector',
                in_channel=2048,
                out_channel=384,
            ...
            loss_2_tfeat=dict(type='RMClsTokenConnector'),
            ),
