...
model = dict(
    ...
    distiller=dict(
        ...
        distill_losses=dict(
            loss_s1=dict(type='ComKDLoss', loss_weight=1, in_channels=3072, out_channels=3072,),
            loss_s2=dict(type='ComKDLoss', loss_weight=1, in_channels=6144, out_channels=6144,),
            loss_s3=dict(type='ComKDLoss', loss_weight=1, in_channels=6144, out_channels=6144,),
            loss_s4=dict(type='ComKDLoss', loss_weight=1, in_channels=24576, out_channels=24576,)),
        connectors=dict(
