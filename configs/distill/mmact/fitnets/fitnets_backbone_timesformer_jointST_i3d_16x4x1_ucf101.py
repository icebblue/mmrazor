...
model = dict(
    ...
    distiller=dict(
       ...
       connectors=dict(
            ...
            loss_s3_sfeat=dict(type='CNNFeatTransfer', in_channel=1024, st_size=(8,14,14), seq_len=1569, t_dim=8, embed_dim=768),
            loss_s4_sfeat=dict(type='CNNFeatTransfer', in_channel=2048, st_size=(8,7,7), seq_len=1569, t_dim=8, embed_dim=768),
            loss_s1_tfeat=dict(type='TransFeatTransfer', in_channel=768, seq_len=1569, t_dim=8, st_size=(8,56,56), embed_dim=256, is_student=False),
            loss_s2_tfeat=dict(type='TransFeatTransfer', in_channel=768, seq_len=1569, t_dim=8, st_size=(8,28,28), embed_dim=512, is_student=False),
            loss_s3_tfeat=dict(type='TransFeatTransfer', in_channel=768, seq_len=1569, t_dim=8, st_size=(8,14,14), embed_dim=1024, is_student=False),
            loss_s4_tfeat=dict(type='TransFeatTransfer', in_channel=768, seq_len=1569, t_dim=8, st_size=(8,7,7), embed_dim=2048, is_student=False)),
