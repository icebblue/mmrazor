...
model = dict(
    ...
    distiller=dict(
        ...
        teacher_recorders=dict(
            bb_s1=dict(type='ModuleOutputs', source='backbone.layer1.2.conv2.bn'),
            bb_s2=dict(type='ModuleOutputs', source='backbone.layer2.2.conv2.bn'),
            bb_s3=dict(type='ModuleOutputs', source='backbone.layer3.5.conv2.bn'),
